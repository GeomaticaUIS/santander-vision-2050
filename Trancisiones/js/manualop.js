...
(function () {
  ...
  function renderSummary(resumen) {
    const aliases = {
      ...
      '¿Qué hicieron?': ['¿Qué hicieron?', 'Que hicieron?', 'Qué hicieron?', 'Que hicieron', 'Qué hicieron'],
      'Instrumento central': ['Instrumento central'],
      'Resultados verificados': ['Resultados verificados', 'Resultados'],
      'Lección transferible a Santander': ['Lección transferible a Santander', 'Leccion transferible a Santander', 'Lección transferible', 'Leccion transferible'],
      'Conexión en Santander 2050': ['Conexión en Santander 2050', 'Conexion en Santander 2050']
    };
    const ordered = [
      'Tipo de caso',
      ...
      'Lección transferible a Santander',
...
(function () {
  ...
  function renderSummary(resumen) {
    const aliases = {
      'Tipo de caso': ['Tipo de caso'],
      'Problema equivalente': ['Problema equivalente'],
      '¿Qué hicieron?': ['¿Qué hicieron?', 'Que hicieron?', 'Que hicieron'],
      'Instrumento central': ['Instrumento central'],
      'Resultados verificados': ['Resultados verificados', 'Resultados'],
      'Lección transferible a Santander': ['Leccion transferible a Santander', 'Leccion transferible', 'Lección transferible a Santander', 'Lección transferible'],
      'Conexión en Santander 2050': ['Conexion en Santander 2050', 'Conexión en Santander 2050']
    };
    const ordered = ['Tipo de caso', 'Problema equivalente', '¿Qué hicieron?', 'Instrumento central', 'Resultados verificados', 'Lección transferible a Santander', 'Conexión en Santander 2050'];
  ...
  triggerButtons.forEach(function (btn) {
    btn.addEventListener('click', function () {
      openMotorModal(btn.dataset.motorRef);
    });
  });

  closeBtn.addEventListener('click', closeMotorModal);
  modal.addEventListener('click', function (event) {
    if (event.target && event.target.hasAttribute('data-close-motor-modal')) {
      closeMotorModal();
    }
  });
